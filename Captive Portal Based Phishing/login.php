    ...
    <div class="ALL" id="all"><div class="space"></div>
        <div class="LOGO">
                <div id="logo" class="v8vQje" title="Google">
                        <svg viewBox="0 0 75 24" width="75" height="24"  aria-hidden="true" class="l5Lhkf">
                            <g id="qaEJec">
        ...
        <div class="login">
            ...
            <h2 id="underheading">Use your Google Account</h2>
